...
namespace ConsoleAppFramework
{
    ...
    public interface IHandler<in TArgument>
    {
        /// <summary>
        ...
        Task<bool> HandleAsync([NotNull] TArgument argument);
    ...
    /// </summary>
    /// <seealso cref="IHandler{TArgument}"/>
    public interface IHandler : IHandler<string[]>
    {
    }
}